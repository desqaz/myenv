...
function s:Gdb_shortcuts()
    nmap <unique> <Tab>b :call Gdb_command("break ".bufname("%").":".line("."))<CR>
    nmap <unique> <Tab>r :Gdb run<CR>
    nmap <unique> <Tab>s :<C-U>Gdb step<CR>
    nmap <unique> <Tab>n :<C-U>Gdb next<CR>
    nmap <unique> <Tab>f :Gdb finish<CR>
    nmap <unique> <Tab>c :<C-U>Gdb continue<CR>
    vmap <unique> <Tab>p "gy:Gdb print <C-R>g<CR>
    nmap <unique> <Tab>p :call Gdb_command("print ".expand("<cword>"))<CR> 
    ...
    vmenu Gdb.Print  "gy:Gdb print <C-R>g<CR>
