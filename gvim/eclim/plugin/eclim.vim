...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/a/nuxcompil12.local/pegasus/jlabarth/tools/eclipse/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/a/nuxcompil12.local/pegasus/jlabarth/tools/eclipse'
  if has('win32unix')
